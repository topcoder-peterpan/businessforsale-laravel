...
@section('title') {{ __('skins') }} @endsection
@section('breadcrumbs')
    <div class="row mb-2">
        <div class="col-sm-6">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="card d-inline-block">
                                <img src="{{ asset('backend/image/theme2.png') }}" width="500px" height="250px" class="card-img-top skin-image"
                                    alt="home page 1">
                                <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class=" card d-inline-block">
                                <img src="{{ asset('backend/image/theme1.png') }}" width="500px" height="250px" class="card-img-top skin-image"
                                    alt="home page 2">
                                <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-4">
                            <div class="card d-inline-block">
                                <img src="{{ asset('backend/image/theme3.png') }}"
                                    class="card-img-top skin-image"
