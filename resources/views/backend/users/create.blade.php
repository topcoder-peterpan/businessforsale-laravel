...
@section('title') {{ __('create_user') }} @endsection
                    ...
                    <div class="row pt-3 pb-4">
                        <div class="col-md-6 offset-md-3">
                            ...
                            <form class="form-horizontal" action="{{ route('user.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">{{ __('email') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">{{ __('password') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">{{ __('assign_roles') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-9">
