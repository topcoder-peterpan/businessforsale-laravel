    ...
    <div class="container">
        <div class="subscribe__content">
            <div class="subscribe__left">
                <h2 class="subscribe__title text--heading-2">{{ __('website.newsletter_header') }}</h2>
                <p class="text--body-3 subscribe__description">
                    {{ __('website.newsletter_description') }}
                </p>
            </div>
            <div class="subscribe__right">
                <form id="mailForm" action="" method="POST">
                    ...
                    <div class="subscribe__input-group @error('email') is-invalid border-danger @enderror">
                        ...
                        <button class="btn" type="submit">{{ __('website.subscribe') }}</button>
                    </div>
