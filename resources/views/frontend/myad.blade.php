...
@section('title', __('website.my_ads'))

@section('content')
 <!-- breedcrumb section start  -->
 <x-frontend.breedcrumb-component :background="$cms->dashboard_my_ads_background_path">
    {{ __('website.overview') }}
    <x-slot name="items">
        ...
        <li class="breedcrumb__page-item">
            <a class="breedcrumb__page-link text--body-3">{{ __('website.my_ads') }}</a>
        </li>
    </x-slot>
                                        ...
                                        <ul class="edit-dropdown">
                                            <li class="edit-dropdown__item">
                                                <a href="{{ route('frontend.post.edit', $ad->slug) }}" class="edit-dropdown__link">
                                                    ...
                                                    <h5 class="text--body-4">{{ __('website.edit') }}</h5>
                                                </a>
                                            </li>
                                            <li class="edit-dropdown__item">
                                                <x-dashboard.view-ad :ad="$ad"></x-dashboard.view-ad>
