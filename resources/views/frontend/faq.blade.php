...
@section('title',__('website.faqs'))

@section('content')
     <!-- breedcrumb section start  -->
     <x-frontend.breedcrumb-component :background="$cms->faq_background_path">
        {{ __('website.faqs') }}
        <x-slot name="items">
            <li class="breedcrumb__page-item">
                <a class="breedcrumb__page-link text--body-3">{{ __('website.faqs') }}</a>
            </li>
        </x-slot>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-{{ $cat_count <= 3 ? 6: 8 }}">
                    <h2 class="faq__title text--heading-1">{{ __('website.frequently_asked_question') }}</h2>
                    <p class="faq__brief text--body-3">
                        {{ __('website.frequently_asked_text') }}
                    </p>
