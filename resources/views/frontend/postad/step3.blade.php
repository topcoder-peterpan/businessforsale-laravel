    ...
    <div class="dashboard-post__step02 step-information">
        ...
        <form action="{{ route('frontend.post.step3.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-field--textarea">
                ...
                <textarea required name="description" placeholder="What’s your thought..." id="description" class="@error('description') border-danger @enderror"></textarea>
            </div>
            <div class="input-field--textarea">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                             <div class="input-field">
                                 <input required name="features[]" type="text" placeholder="Feature" id="adname" class="@error('title') border-danger @enderror"/>
                             </div>
                        </div>
