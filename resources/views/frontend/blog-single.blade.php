...
@endsection
@php
    $keywords = sprintf("%s, %s",$settings->seo_meta_keywords, join(', ',$tags->pluck('name')->all()));
@endphp
...
<x-frontend.breedcrumb-component :background="$cms->blog_background_path">
    ...
    <x-slot name="items">
        <li class="breedcrumb__page-item">
            <a href="{{ route('frontend.blog') }}" class="breedcrumb__page-link text--body-3">{{ __('website.blog') }}</a>
        </li>
        <li class="breedcrumb__page-item">
...
<section class="section single-blog">
    <div class="container">
        <div class="single-blog__lg-img-wrapper">
            <img src="{{ asset($blog->image)  }}" alt="blog-img" class="img-fluid">
        </div>
                ...
                <div class="single-blog__blog-content">
                    <ul class="single-blog__info">
                        ...
                        <li class="single-blog__info-item">
                            ...
                            <p class="text--body-3" id="comment_count"> {{ $blog->comments_count }} {{ __('website.comments') }}</p>
                        </li>
                    </ul>
                    ...
                    <div class="single-blog__author-info">
                        ...
                        <ul class="author-social">
                            <li class="author-social__item">
                                <a href="{{ socialMediaShareLinks('/blog/', $blog->slug)['whatsapp'] }}" class="social-link social-link--wa  author-social__link">
                                    <x-svg.whatsapp-icon />
                                </a>
                            </li>
                            <li class="author-social__item">
                                <a href="{{ socialMediaShareLinks('/blog/', $blog->slug)['facebook'] }}" class="social-link social-link--fb  author-social__link">
                                    <x-svg.facebook-icon fill="#fff"/>
                                </a>
                            </li>
                            <li class="author-social__item">
                                <a href="{{ socialMediaShareLinks('/blog/', $blog->slug)['twitter'] }}" class="social-link social-link--tw  author-social__link">
                                    <x-svg.twitter-icon fill="#fff" />
                                </a>
                            </li>
                            <li class="author-social__item">
                                <a href="{{ socialMediaShareLinks('/blog/', $blog->slug)['linkedin'] }}" class="social-link social-link--in  author-social__link">
                                    <x-svg.linkedin-icon />
                                </a>
                            </li>
                            <li class="author-social__item">
                                <a href="{{ socialMediaShareLinks('/blog/', $blog->slug)['gmail'] }}" class="social-link social-link--p  author-social__link">
                ...
                <div class="blog__sidebar ">
                    ...
                    <div class="blog__sidebar-wrapper">
                        ...
                        <div class="blog__sidebar-category blog__sidebar-item">
                            <h2 class="text--body-2-600 item-title">{{ __('website.top_category') }}</h2>
                            <div class="category">
                                @forelse ($categories as $category)
                                    <div class="category-item">
                                        <a href="{{ route('frontend.blog',['category'=>$category->slug]) }}">
                                            <img style="width: 168px;" src="{{ asset($category->image) }}" alt="category-img">
                        ...
                        <div class="blog__sidebar-tag blog__sidebar-item">
                            <h2 class="text--body-2-600 item-title">{{ __('website.popular_tag') }}</h2>
                            <div class="tags">
                                @forelse ($tags->take(6) as $tag)
                                    <span class="tags-item text--body-3"> {{ $tag->name }} </span>
                                @empty
                                <x-no-data-found/>
                                @endforelse
                            </div>
                        ...
                        <div class="blog__sidebar-post blog__sidebar-item">
                            <h2 class="text--body-2-600 item-title">{{ __('website.recent_post') }}</h2>
                            <div class="post">
                                ...
                                <div class="post-item">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="post-review">
                                            ...
                                            <span class="dot"></span>
                                            <span class="comments"> {{ $post->comments_count }}  {{ __('website.comments') }} </span>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
