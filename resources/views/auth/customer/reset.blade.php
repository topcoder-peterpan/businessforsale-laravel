    ...
    <x-frontend.breedcrumb-component :background="$cms->default_background_path">
        ...
        <x-slot name="items">
            <li class="breedcrumb__page-item">
                <a class="breedcrumb__page-link text--body-3">{{ __('website.reset_password') }}</a>
            </li>
        </x-slot>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 order-1 order-lg-0">
                    <div class="registration-form">
                        <h2 class="text-center text--heading-1 registration-form__title">{{ __('website.reset_password') }}</h2>
                        <div class="registration-form__wrapper">
                            <form method="POST" action="{{ route('customer.password.update') }}">
                                ...
                                <div class="input-field d-none">
                                    <input type="email" placeholder="{{ __('website.email_address') }}" name="email" value="{{ request('email','') }}"  class="@error('email') is-invalid border-danger @enderror" />
                                    @error('email')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="input-field">
                                    <input type="password" placeholder="{{ __('website.new_password') }}" id="password" name="password" class="@error('password') is-invalid border-danger @enderror" />
                                ...
                                <div class="input-field">
                                    <input type="password" placeholder="{{ __('website.confirm_password') }}" id="confirmPassword" name="password_confirmation" class="@error('password_confirmation') is-invalid border-danger @enderror" />
