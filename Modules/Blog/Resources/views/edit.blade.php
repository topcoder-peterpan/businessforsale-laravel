...
@section('title') {{ __('edit_post') }} @endsection
@section('content')
                    ...
                    <div class="row justify-content-center pt-3 pb-4">
                        <div class="col-md-9 px-5">
                            <form class="form-horizontal" action="{{ route('module.post.update', $post->id) }}"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{ __('title') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{ __('category') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ __('short_description') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{ __('description') }}<small class="text-danger">*</small></label>
                                    <div class="col-sm-10">
                        ...
                        <div class="col-md-3 text-center">
                            ...
                            <div class="upload-btn-wrapper mt-3">
                                ...
                                <button onclick="$('#hiddenImgInput').click()" class="btn btn-info" type="button">{{ __('choose_an_image') }}</button>
                            </div>
