            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header text-dark d-flex justify-content-between align-items-center">
                        <h6 class="d-inline mb-2"> Gallery Add</h6>
                    </div>
                    <div class="card-body">
                        <form id="dropzoneForm" method="post" action="{{ route('module.ad.store_gallery', $id) }}" enctype="multipart/form-data" class="dropzone" >
                            @csrf
                        </form>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('module.ad.index') }}" class="btn bg-primary float-right d-flex align-items-center justify-content-center"><i class="fas fa-arrow-left"></i>&nbsp;Back</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($adGalleries  as $gallery )
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($gallery->image)
                                                    <img width="60px" height="60px" src="{{ asset($gallery->image) }}" alt="">
                                                @else
                                                    <img width="60px" height="60px" src="{{ asset('backend/image/default-ad.png') }}" alt="">
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <form action="{{ route('module.ad.delete_gallery', $gallery->id) }}" method="POST" class="d-inline">
                                                    @method('DELETE')
                                                    @csrf
