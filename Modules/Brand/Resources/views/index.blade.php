...
@section('title') {{ __('brand_list') }} @endsection
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (userCan('brand.create'))
                            <a href="{{ route('module.brand.create') }}" class="btn bg-primary float-right d-flex align-items-center justify-content-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if (userCan('brand.update'))
                                            <a title="{{ __('edit_brand') }} " href="{{ route('module.brand.edit', $brand->id) }}" class="btn bg-info mr-1">
