...
@section('content')
    <div class="container-fluid">
        ...
        <div class="text-right mb-3">
            <a href="{{ route('module.testimonial.create') }}" class="btn btn-primary"><i
                class="fas fa-plus"></i> {{ __('add_testimonial') }}</a>
        </div>
        @endif
        <div class="row">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mx-auto justify-content-center align-items-center">
                            ...
                            <a title="{{ __('edit_testimonial') }}" href="{{ route('module.testimonial.edit', $testimonial->id) }}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                          @endif
