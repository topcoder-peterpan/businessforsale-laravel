...
@section('title') {{ __('send_mail') }} @endsection
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8">
                                <h3>{{ __('send_mail') }}</h3>
                                <p>You can send a mail to multiple email addresses</p>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('module.newsletter.submit_mail') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="emails[]" class="select2bs4 @error('emails') is-invalid @enderror"
                                        style="width: 100%;" multiple data-placeholder="{{ __('start_typing_for_search') }}">
                                        @foreach ($emails as $email)
                                            <option
                                                {{ collect(old('emails'))->contains($email->id) ? 'selected' : '' }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="subject" class="form-control" value="{{ old('subject') }}" placeholder="{{ __('write_the_subject_here') }}">
